export default {
  ...
  // titan
  'menu.cache.profile': '详情页',
  'cacheProfile.title': '缓存详情',
  'cacheProfile.column.CarfileHash': 'Hash',
  'cacheProfile.column.DeviceID': '设备ID',
  'cacheProfile.column.Status': '状态',
  'cacheProfile.column.DoneSize': '完成大小',
  'cacheProfile.column.DoneBlocks': '完成Blocks',
  'cacheProfile.column.IsCandidate': '是否候选节点',
  'cacheProfile.column.CreateTime': '创建时间',
  'cacheProfile.column.EndTime': '结束时间',

  'cacheProfile.cell.create': '创建',
  'cacheProfile.cell.running': '执行中',
  'cacheProfile.cell.failed': '失败',
  'cacheProfile.cell.succeeded': '完成',
  'cacheProfile.cell.yes':'是',
  'cacheProfile.cell.no':'否',
};
